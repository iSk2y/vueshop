...
from .models import GoodsCategory, Goods, GoodsImage, Banner, GoodsCategoryBrand, IndexAd
...
class IndexCategorySerializer(serializers.ModelSerializer):
    ...
    def get_ad_goods(self, obj):
        ...
        if ad_goods:
            ...
            goods_json = GoodSerializer(good_ins, many=False, context={'request': self.context['request']}).data
        return goods_json
